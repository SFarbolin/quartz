...
const config: QuartzConfig = {
  configuration: {
    ...
    enablePopovers: true,
    analytics: {
      provider: 'goatcounter', websiteId: 'farbolin'
    },
    locale: "en-US",
    baseUrl: "farbolin.me",
    ...
    theme: {
      ...
      colors: {
        lightMode: {
// These are the original values for lightMode. I'm being hacky and overwriting them with dark mode values to foce dark mode.
//          light: "#faf8f8",
//          lightgray: "#e5e5e5",
//          gray: "#b8b8b8",
//          darkgray: "#4e4e4e",
